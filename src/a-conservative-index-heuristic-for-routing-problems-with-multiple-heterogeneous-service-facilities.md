...
- Vincent Knight
- Paul Harper
details: Mathematical Methods of Operations Research, 92, pp. 511--543
...
tags:
- article
title: A conservative index heuristic for routing problems with multiple heterogeneous
  service facilities
---
...
```bibtex
@article{shone2020conservative,
  title   = {A conservative index heuristic for routing problems with multiple
             heterogeneous service facilities},
  author  = {Shone, Rob and Knight, Vincent A. and Harper, Paul R.},
  journal = {Mathematical Methods of Operations Research},
  volume  = {92},
  pages   = {511--543},
  year    = {2020},
  doi     = {10.1007/s00186-020-00722-w},
  url     = {https://link.springer.com/article/10.1007/s00186-020-00722-w},
}
```
