...
\begin{itemize}
    ...
    \item {\sl Fellow of the Sustainable Software Institute}

    \item {\sl Chair of the OR in Schools taskforce}

    \item {\sl Area editor for Health Systems}

    \item {\sl Member of the Phoenix project advisory board}

    \item {\sl Organiser of the Cardiff Python user group meetup}
...
\begin{itemize}
    ...
    \item DjangoCon Europe 2015: I was on the organising committee for this year's DjangoCon Europe.
